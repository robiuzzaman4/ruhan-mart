...
const ProductCarouselCard = ({ _id, product_name, product_price, product_weight, product_image }: TProduct) => {
    ...
    return (
        <div className={`w-[20rem] bg-white shadow-sm rounded-lg p-4 flex flex-col gap-2`}>
            <Image
                src={product_image}
                alt="Product Image"
                height={400}
